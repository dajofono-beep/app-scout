  ...
  return (
    <div className="max-w-lg">
      ...
      <div className="space-y-2 mb-6">
        {(escala ?? []).map((e) => (
          <form
            ...
            className="bg-white rounded-xl shadow-sm p-3 flex items-center gap-2"
          >
            ...
            <input
              ...
              className="border border-slate-200 rounded-lg px-3 py-1.5 w-24"
            />
            <span className="text-sm text-slate-500">%</span>
            <button type="submit" className="text-sm text-sky-600 font-semibold">
              Guardar
            </button>
            <button
      ...
      <form
        ...
        className="bg-white rounded-xl shadow-sm p-4 flex items-end gap-2"
      >
        <div>
          <label className="block text-xs text-slate-500 mb-1">Posición</label>
          <input
            name="posicion"
            type="number"
            min="1"
            ...
            className="border border-slate-200 rounded-lg px-3 py-1.5 w-20"
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          className="bg-sky-600 text-white rounded-full px-4 py-2 font-bold"
        >
          Agregar
        </button>
      </form>
